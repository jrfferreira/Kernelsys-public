...
{ 
	...
	// 30 a 30  D�gito verificador do código de barras
	// 31 a 34  Fator de vencimento (qtdade de dias desde 07/10/1997 até a data de vencimento)
	// 35 a 44  Valor do t�tulo
	
	// 1. Primeiro Grupo - composto pelo código do banco, código da mo�da, Valor Fixo "9"
  ...
  $campo1 = substr($campo1, 0, 5).'.'.substr($campo1, 5);
	...
	// 2. Segundo Grupo - composto pelas 3 �ltimas posi�oes do PSK e 7 primeiros d�gitos do Nosso Número
