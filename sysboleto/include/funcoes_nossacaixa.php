...
//pega o nosso numero a partir da 2� posição
$nnum = substr($nnum,1);

//numero para o calculo dos d�gitos verificadores da posição 43 e 44
$calcdv1 = $prefixo.$nnum.$ag_contacedente.$codigobanco;

//Gera os d�gitos verificadores da posição 43 e 44
