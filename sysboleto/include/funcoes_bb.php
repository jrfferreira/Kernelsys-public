...
if ($dadosboleto["formatacao_convenio"] == "7") {
	...
	// Nosso Número de até 10 d�gitos
...
if ($dadosboleto["formatacao_convenio"] == "6") {
	...
	if ($dadosboleto["formatacao_nosso_numero"] == "2") {
		...
		// Nosso Número de até 17 d�gitos
		$nservico = "21";
...
ESTA FUNção PEGA O D�GITO VERIFICADOR DO PRIMEIRO, SEGUNDO
...
function modulo_11($num, $base=9, $r=0) {
	...
	if ($r == 0) {
		...
		O Módulo 11 s� gera os digitos verificadores do nossonumero,
		...
		*/
		...
		if (strlen($num) == "43") {
			//ent�o estamos checando a linha Digitável
