...
// 43 n�meros para o c�lculo do d�gito verificador do código de barras
// retorna 44 n�meros que são 43 + 1 d�gito verificador formando 44 posições
...
function modulo_10($num) { 
        ...
        for ($i = strlen($num); $i > 0; $i--) {
            ...
            // monta código para soma dos digitos no (modulo 10)
...
function modulo_11($num)  {
     ...
     *
     *   Observações:
     *     - Script desenvolvido sem nenhum reaproveitamento de código pr� existente.
     *     - Assume-se que a verificação do formato das vari�veis de entrada � feita antes da execução deste script.
     */                                        
...
{ 
	...
	// 10 a 19  Valor do t�tulo (10 posições)
...
function monta_linha_digitavel($linha){
	// 1�. Campo: composto pelo código de Banco, código da moeda, as cinco primeiras posições  do campo livre e  d�gito verificador (Módulo 10) deste campo;
    // 2�. Campo: composto pelas  posições 6�. � 15�. do  campo livre e d�gito verificador (Módulo 10) deste campo;
    // 3�. Campo: composto pelas posições 16�. � 25�. do campo livre e d�gito  verificador (Módulo 10) deste campo;
    // 4�. Campo: D�gito verificador do código de barras (d�gito de autoconfer�ncia);
    // 5�. Campo: Composto pelo Fator de  Vencimento (anexo 7) e o Valor Nominal do documento, com a inclus�o  de  zeros entre eles até compor as 14 posições do campo,  e sem edição de ponto e v�rgula. 
    //            Quando se tratar de bloqueto sem discriminação de valor no código de barras a representação dever� ser com zeros. 
