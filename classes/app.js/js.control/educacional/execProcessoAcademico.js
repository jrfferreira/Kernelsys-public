...
function alteraDisciplinaAlunoEspecial(codigodisciplinaantiga,codigodisciplinanova,codigoturmadisciplina){
	
	coddisciplinaantiga = $('#' + codigodisciplinaantiga).val();
	coddisciplinanova = $('#' + codigodisciplinanova).val();
	codturmadisciplina = $('#' + codigoturmadisciplina).val();
		
	if((coddisciplinaantiga != 0 || coddisciplinanova != 0) && codturmadisciplina != 0){	
		var dados = 'classe=TProcessoAcademico&metodo=setRegularizacaoAlunoEspecial&codigodisciplinaantiga=' + coddisciplinaantiga + '&codigodisciplinanova=' + coddisciplinanova + '&codigoturmadisciplina=' + codturmadisciplina;
