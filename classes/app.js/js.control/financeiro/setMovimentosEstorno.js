 ...
 * @return
 */
function setMovimentosEstorno(ob,idForm){
    if(confirm('É necessário confirmar a inclusão dos movimentos selecionados.\r\nApós este passo, uma nova movimentação será gerada.\r\n\r\nDeseja continuar?')){
        ...
        var ret = new String(exe('',getPath()+'/app.util/TSec.php?classe=TCaixa&metodo=setMovimentosEstorno&idForm='+idForm,'','GET','Sucesso'));
