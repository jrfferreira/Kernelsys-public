function setAlunoFalta(ob,codigoturma,aluno,codigoaula,numeroaula){
    ...
    Valores = '&tudiseq='+codigoturma+'&codigoaluno='+aluno+'&codigoaula='+codigoaula+'&aula='+numeroaula+'&situacao='+situacao;
...
function setJustificativa(ob,codigoturma,aluno,codigoaula){
    ...
    Valores = '&tudiseq='+codigoturma+'&codigoaluno='+aluno+'&codigoaula='+codigoaula+'&just='+justificativa;
