    ...
    */
    public function runConciliacao($arquivo){
        ...
        $obMasc = new TSetMascaras();
            ...
            $dboDadosBoleto = new TDbo(TConstantes::DBBOLETO_ESTRUTURA);
                $criteriaBoleto = new TCriteria();
                $criteriaBoleto->add(new TFilter('statseq','=','1'));
            $retDadosBoleto =   $dboDadosBoleto->select('cofiseq', $criteriaBoleto);
                ...
                elseif($dados['servico_seguimento'] == 'U'){
                 ...
                 $obDup = $retDup->fetchObject();
                     ...
                     if($obDup->ndocumento == $dadosRet['nosso_numero']){
                         ...
                         //retorna  pessoa
                         $dboPessoa = new TDbo(TConstantes::DBPESSOA);
                            $criteriaPessoa = new TCriteria();
                            $criteriaPessoa->add(new TFilter("seq","=",$obDup->pessseq));
                         $retPessoa = $dboPessoa->select('pessnmrz', $criteriaPessoa);
                        ...
                        $rowRet->add('<span class="tlabel">Nome do Sacado:</span> '.$obPessoa->pessnmrz.'<br>');
