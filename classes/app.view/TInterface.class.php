...
/*     $pesq = new TElement('input');
    $pesq->type = 'text';
    $pesq->maxlength = '17';
    $pesq->style = 'width: 120px; margin-top: 2px; margin-right: 2px; margin-bottom: 2px; margin-left: 4px; font-size: 12px; border-top-left-radius: 3px 3px; border-top-right-radius: 3px 3px; border-bottom-right-radius: 3px 3px; border-bottom-left-radius: 3px 3px; ';
