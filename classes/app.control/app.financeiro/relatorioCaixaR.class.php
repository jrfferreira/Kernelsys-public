	...
	public function get(){
		...
		//if($conn = TTransaction::get()){////////////////////////////////////////////////////////////////////
			...
			//================================================
				...
				//$sqlContas = "select codigo,nomeConta from dbcontas where tipoConta='C' and unidade='".$this->obUser->unidade->codigo."'";
				//$retContas = $conn->Query($sqlContas);
				
				while($obContas = $retContas->fetchObject()){
					$contas[$obContas->codigo]['receita']  = $obContas->nomeConta;
				}
		...
		//===================================
			...
			// Retorna informações do caixa  ==========================
				...
				//$sqlCaixa = "select * from dbcaixa where ".$dataArg." and tipomovimentacao='C' and unidade='".$this->obUser->unidade->codigo."'";
