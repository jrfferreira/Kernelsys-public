...
class viewBPatrimonial {
    ...
    //retorna Conta D�bito
        ...
        $obTDboC = new TDbo(TConstantes::DBPARCELA);
        ...
        while($idContaD = $obContaD->fetchObject()) {
            ...
            $vetCategorias[$idContaD->seq] = $idContaD->categoria;
        }
    ...
    public function get($dataBP) {
        ...
        if ($dataBP != NULL) {
            ...
            //            //Inicio  (Titulos)
            //            $tabBPatrimonial .= '<tr><td height="25px" align="center" class="tdatagrid_col">statseq</td><td height="25px" align="center" class="tdatagrid_col">Passivo</td></tr>';
