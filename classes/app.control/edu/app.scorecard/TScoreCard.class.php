...
class TScoreCard {
    ...
    public function setParam($param) {
        ...
        $this->listseq 	 = $this->obsession->getValue('listseq');
        $this->scorecard = $this->obsession->getValue('seqatual'.$this->listseq);
    }
    ...
    //INICIO - Criação de vetores
        ...
        $critScorecard->add(new TFilter("seq","=",$this->scorecard));
        ...
        $critSentencas->add(new TFilter("seqScorecard","=",$this->scorecard));
