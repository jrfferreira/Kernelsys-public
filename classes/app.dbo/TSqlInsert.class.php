<?php
/*
 * classe TSqlInsert Esta classe prov� meios para manipulação de uma instrução
 * de INSERT no banco de dados
 */
final class TSqlInsert extends TSqlInstruction {
	/*
	 * método setRowData() Atribui valores � determinadas colunas no banco de
	 * dados que ser�o inseridas param $column = coluna da tabela param $value =
	...
	/*
	 * método getInstruction() retorna a instrução de INSERT em forma de string.
	 */
