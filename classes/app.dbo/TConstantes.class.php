...
class TConstantes{
    ...
    const DBUNIDADES_PARAMETROS             = "dbunidades_parametros";
    ...
    const DBUSUARIOS_HISTORICO              = "dbusuarios_historico";
